...
export interface IroombookingConnectorConnectState extends ITeamsBaseComponentState {
    color: IColor | undefined;
    submit: boolean;
}

export interface IroombookingConnectorConnectProps extends ITeamsBaseComponentProps {
    webhookUrl: string;
    user: string;
    appType: string;
    groupName: string;
...
/**
 * Implementation of the roombookingConnector Connector connect page
 */
export class roombookingConnectorConnect extends TeamsBaseComponent<IroombookingConnectorConnectProps, IroombookingConnectorConnectState> {
