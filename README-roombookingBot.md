# roombooking Bot - `roombookingBot`
...
3. Give the bot a handle (ex:`roombookingBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://roombookingdemo.herokuapp.com/api/messages`
